...
class Options(Subwindow):
    ...
    def build_gui(self):
        ...
        self.code_font_size_SBX = wdg.Spinbox(self.code_font_FRM, self.subroot, textvariable = self.code_font_size_VAR, min = 5, max = 30, default = self.code_font_size_VAR.get(), height = 5)
        ...
        self.min_adr_len_SBX = wdg.Spinbox(self.min_adr_len_FRM, self.subroot, textvariable = self.min_adr_len_VAR, min = 1, max = 10, default = self.min_adr_len_VAR.get(), height = 5)
        ...
        self.max_cels_SBX    = wdg.Spinbox(self.max_cels_FRM, self.subroot, textvariable = self.max_cels_VAR, min = 1, max = 1048576, default = self.max_cels_VAR.get(), threshold = 1, height = 5)
        ...
        self.max_jmps_SBX    = wdg.Spinbox(self.max_jmps_FRM, self.subroot, textvariable = self.max_jmps_VAR, min = 1, max = 1048576, default = self.max_jmps_VAR.get(), threshold = 1, height = 5)
