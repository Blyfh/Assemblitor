...
try:
    ...
    display_warning("Missing Package",
                    f"Needs Python package Pillow {min_pil_ver[0]}.{min_pil_ver[1]}.{min_pil_ver[2]}+ to work properly."
...
if cur_pil_ver < min_pil_ver:
    display_warning("Unsupported Version",
                    f"Your version of Pillow is not supported. Please use version "
                    f"{min_pil_ver[0]}.{min_pil_ver[1]}.{min_pil_ver[2]} or higher.")
    sys.exit()
else:
...
if cur_version >= min_version:
    ...
    display_warning("Unsupported Version",
                    f"Your version of Python is not supported. "
